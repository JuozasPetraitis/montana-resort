...
const OffersData = [
  [Offer1, 'Up to 35% savings on Club rooms and Suites', 'Luxuries condition', '3 Adults & 2 Children size', 'Sea view side'],
  [Offer2, 'Up to 35% savings on Club rooms and Suites', 'Luxuries condition', '3 Adults & 2 Children size', 'Sea view side'],
  [Offer3, 'Up to 35% savings on Club rooms and Suites', 'Luxuries condition', '3 Adults & 2 Children size', 'Sea view side'],
];
          ...
          {OffersData.map((item) => (
            <div className="flex flex-col gap-4 md:gap-2" key={Math.random()}>
              ...
              <div className="flex flex-col gap-4 px-4 md:justify-between">
                ...
                <button className="py-2 px-12 border rounded-sm border-blue-400 text-blue-800 font-semibold self-center hover:tracking-wider">Book now</button>
              </div>
            </div>
          ))}
        </div>
