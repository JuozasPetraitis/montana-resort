    ...
    <div className="container m-auto flex flex-col my-10 gap-8">
      <div>
        ...
        <form onSubmit={onSubmitFunction} className="flex flex-col gap-4 max-w-lg m-auto">
          <input type="text" placeholder="Enter your name" className="border border-black md:rounded py-2 px-4 w-auto text-black" />
          <input type="text" placeholder="Enter your email" className="border border-black md:rounded py-2 px-4 w-auto text-black" />
          <input type="text" placeholder="Enter your subject" className="border border-black md:rounded py-2 px-4 w-auto text-black" />
          <input type="text" placeholder="Enter your message" className="border border-black md:rounded py-2 px-4 w-auto text-black" />
          <input type="submit" value="Send us a message" className="bg-black text-white w-2/3 m-auto py-2 font-semibold cursor-pointer" />
        </form>
      </div>
