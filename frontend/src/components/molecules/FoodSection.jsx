  ...
  return (
    <div className="container m-auto flex flex-col gap-8 px-0.5 py-8">
      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:items-center">
        <div className="flex flex-col gap-8 lg:w-2/5 lg:order-1">
          ...
          <Link to="/about">
            <p className="text-lg border-b-2 border-blue-300 inline-block">Learn More</p>
          </Link>
        </div>

        <div className="flex lg:w-3/5 px-0.5 lg:order-0">
          <div className="w-1/2 h-80 pb-8 mr-2 lg:h-96">
            <img className="w-full h-full object-cover" src={Food1} alt="Salads" />
          </div>
          <div className="w-1/2 h-80 pt-8 lg:h-96 lg:ml-5">
